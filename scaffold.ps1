...
# File: front_nvide/scaffold.ps1
# Cara penggunaan: .\scaffold.ps1 -Name "posts"
...
if ([string]::IsNullOrEmpty($Name)) {
    Write-Host "⚠️ Error: Nama dashboard page tidak boleh kosong!" -ForegroundColor Red
    Exit
}

# Standarisasi Penamaan
# Contoh: "posts" -> CamelCase: "Posts", lowercase: "posts"
$LowerName = $Name.ToLower()
$TitleName = $LowerName.Substring(0,1).ToUpper() + $LowerName.Substring(1)

Write-Host "🚀 Menghasilkan Halaman Dashboard Boilerplate Next.js untuk: $TitleName..." -ForegroundColor Cyan
...
Write-Host "✅ Selesai! Halaman dashboard boilerplate telah berhasil dibuat di:" -ForegroundColor Green
Write-Host " 📂 Halaman Page: [page.tsx]" -ForegroundColor Gray
Write-Host "💡 Anda sekarang dapat membuka http://localhost:3000/dashboard/$LowerName di browser Anda!" -ForegroundColor Yellow
